...
pipeline {
    ...
    environment {
        author_name = "V.Kozlov, Not V.Kozlov"
        author_email = "valentin.kozlov@gmail.com, valentin.kozlov@kit.edu"
        app_name = "cctestx"
        job_location = "Pipeline-as-code/DEEP-OC-org/DEEP-OC-cctestx/${env.BRANCH_NAME}"
    }
